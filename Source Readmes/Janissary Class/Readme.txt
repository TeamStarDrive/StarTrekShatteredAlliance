Continuing my line of replacement Cardassian ships I present the new Janissary Class, made by kitbashing Zorgs Galor Class. The model has 4 textures and a poly count of 498.

This will act as a replacement for your Janissary Class (cassault).
...
1. Place "cassault.sod" into the Activision/Star Trek Armada II/SOD folder.
2. Place all files found in the RGB folder into the Activision/Star Trek Armada II/Textures/RGB folder.
3. Place "cassault.odf" into the Activision/Star Trek Armada II/odf/ships folder.
4. Place the "cassault.bmp" file found in the ShipImages folder into the Activision/Star Trek Armada II/bitmaps/AdmiralsLog/ShipImages folder.
...
and delete the entry for cassault
...
cassaultw1			WFcassault	0	0	64	64
cassaultw2			WFcassault	0	0	64	64
cassaultw3			WFcassault	0	0	64	64
cassaultw4			WFcassault	0	0	64	64
cassaultw5			WFcassault	0	0	64	64
